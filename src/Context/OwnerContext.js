  ...
  foodItems: [
    {
      ...
      basePrise: 15,
      available: false,
      image_url: "https://img.etimg.com/photo/msid-69212931,quality-100/chai-itself-was-once-a-trend-that-developed-this-way-.jpg",
      stars: 0,
      number_of_rating: 0,
      canteen_id: 1,
    },
    {
      ...
      basePrise: 30,
      available: false,
      image_url: "https://yummytummyrecipes.com/wp-content/uploads/2021/02/Image-of-Dabeli-min-scaled.jpg",
      stars: 0,
      number_of_rating: 0,
      canteen_id: 1,
    },
...
function OwnerProvider({ children }) {
  ...
  return (
    <OwnerStateContext.Provider value={{ ...state, UpdateFoodItem }}>
